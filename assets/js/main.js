...
function zakialert(){
  let text ="You will be directed to an external website. Are you sure that you want to proceed?";
...
function tryalert(){
  if(confirm("You will be directed to an external website. Are you sure that you want to proceed?")){
    // location.href="https://www.nsilindia.co.in/","_blank"
    window.open("https://www.nsilindia.co.in/", "_blank");
  }
  else{
    // location.href="#"
  }
...
function Second_Launch_Pad(){
  if(confirm("You will be directed to an external website. Are you sure that you want to proceed?")){
    window.open("https://www.nsilindia.co.in/launch-services", "_blank");
  }
  else{
  }
}
